...
## v1.2.0 (2026-06-26) — 桌面体验打磨

### 新增
- **窗口尺寸记忆**：config.json 持久化窗口位置和大小，重启恢复
- **macOS 系统托盘**：基于 rumps 的最小化到托盘，菜单「显示 Canopy / 退出」
- **24h 模拟交易报告**：data/sim_24h_report.md，5 策略在 BTC/USDT 真实数据上的模拟结果

### 改进
- **暗色主题优化**：KPI 数值增加文字发光效果，卡片/导航栏阴影适配暗色模式
- **暗色输入框**：表单元素在暗色模式下提升对比度和可读性
